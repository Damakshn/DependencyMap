...
class BrowseObjectWidget(BrowseWidget):
    """
    Виджет для просмотра внутренностей сложного объекта: базы данных,
    арма или всей системы в целом.

    Виджет содержит область с вкладками, каждая вкладка отвечает за
    определённую категоию вложенных объектов;
